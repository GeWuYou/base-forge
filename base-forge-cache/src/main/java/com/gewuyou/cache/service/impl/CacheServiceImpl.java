package com.gewuyou.cache.service.impl;
...
import com.gewuyou.common.exception.CacheException;
...
public class CacheServiceImpl implements ICacheService {
    ...
    @Autowired
    public CacheServiceImpl(ObjectMapper objectMapper, RedisTemplate<String, Object> redisTemplate) {
    ...
    public void setObject(String key, Object value, long timeout, TimeUnit unit) {
        try {
            ...
            throw new CacheException(ResponseInformation.JSON_SERIALIZE_ERROR);
        }
    }
    ...
    public <T> T getObject(String key, Class<T> clazz) {
        ...
        try {
            ...
            throw new CacheException(ResponseInformation.JSON_DESERIALIZE_ERROR);
        }
    }
