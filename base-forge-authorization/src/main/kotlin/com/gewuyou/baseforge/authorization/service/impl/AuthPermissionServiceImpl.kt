...
import com.gewuyou.baseforge.authorization.constant.AuthorizationConstant
import com.gewuyou.baseforge.authorization.dto.AuthPermissionRoleDto
import com.gewuyou.baseforge.authorization.mapper.AuthPermissionMapper
 ...
 */
@Service
class AuthPermissionServiceImpl(
    ...
    private fun loadPermissionsToCache() = baseMapper.getAuthPermissionRoleDtoList()
        .stream()
        .forEach {
            val key = AuthorizationConstant.PERMISSION_CACHE_PREFIX + "$it.url:$it.requestMethod"
    ...
    override fun getAuthPermissionRoleDtoList(): List<AuthPermissionRoleDto> {
       return baseMapper.getAuthPermissionRoleDtoList()
    }
